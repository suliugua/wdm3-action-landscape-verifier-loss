...
JOBS = [
    # Phase C: sign-gate + banded, paired against unified_protocol (null+banded).
    # Listed in the frozen early-stop order (s7 -> s2 -> s3, then s1 -> s4).
    # Same accept-type vocabulary as the baseline arm, which is what makes the
    # two sides comparable.
    ("seed7", "sign_banded_unified", 0, {"wu_a", "probe_a", "bb_a", "bs_a"}),
    ("seed2", "sign_banded_unified", 0, {"wu_a", "probe_a", "bb_a", "bs_a"}),
    ("seed3", "sign_banded_unified", 0, {"wu_a", "probe_a", "bb_a", "bs_a"}),
    ("seed1", "sign_banded_unified", 0, {"wu_a", "probe_a", "bb_a", "bs_a"}),
    ("seed4", "sign_banded_unified", 0, {"wu_a", "probe_a", "bb_a", "bs_a"}),
]
